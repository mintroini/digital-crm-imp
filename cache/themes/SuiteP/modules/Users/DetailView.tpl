...
<input title="Reset Password" class="button" LANGUAGE="javascript" onclick="generatepwd('{$fields.id.value}');" type="button" name="password" value="Reset Password"/>
...
<li><input title="Reset Password" class="button" LANGUAGE="javascript" onclick="generatepwd('{$fields.id.value}');" type="button" name="password" value="Reset Password"/></li>
