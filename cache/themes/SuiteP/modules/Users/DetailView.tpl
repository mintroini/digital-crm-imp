...
<input title="Restablecer Contraseña" class="button" LANGUAGE="javascript" onclick="generatepwd('{$fields.id.value}');" type="button" name="password" value="Restablecer Contraseña"/>
...
<li><input title="Restablecer Contraseña" class="button" LANGUAGE="javascript" onclick="generatepwd('{$fields.id.value}');" type="button" name="password" value="Restablecer Contraseña"/></li>
