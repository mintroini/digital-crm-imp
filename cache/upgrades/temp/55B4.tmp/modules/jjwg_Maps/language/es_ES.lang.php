...
$mod_strings['LBL_CONFIG_GEOCODING_API_SECRET_GET_A_KEY'] = 'Consiga un clave gratuita para la API de Geocodificación de Google Maps (para geocodificar diaria y gratuitamente una generosa cantidad de direcciones).';
