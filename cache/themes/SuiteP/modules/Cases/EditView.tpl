...
{/if}  
<input type='text' name='{$fields.serial_nbr_c.name}' 
id='{$fields.serial_nbr_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
addToValidate('EditView', 'serial_nbr_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_SERIAL_NBR' module='Cases' for_js=true}{literal}' );
